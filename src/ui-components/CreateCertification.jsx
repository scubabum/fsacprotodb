...
export default function CreateCertification(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setQualtype(initialValues.qualtype);
    setAgency(initialValues.agency);
    setCertNum(initialValues.certNum);
    setCertDate(initialValues.certDate);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new Certifications(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "CreateCertification")}
    >
      <TextField
